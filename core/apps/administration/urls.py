...
urlpatterns = [
    ...
    path("contact-email", views.ContactEmailCreateView.as_view(), name="contact-email-create"),
    path("contact-phone", views.ContactPhoneCreateView.as_view(), name="contact-phone-create"),
    path("social-media-link", views.SocialMediaLinkCreateView.as_view(), name="social-media-link-create"),
    path("company-info", views.CompanyInfoCreateView.as_view(), name="company-info-create"),
