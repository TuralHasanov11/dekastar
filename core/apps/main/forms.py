...
class ContactForm(forms.Form):
    name = forms.CharField(label=_('Your name'), widget=forms.TextInput(
        attrs={'class': 'form-control',
               'title': _('Please enter your full name'), 'placeholder': _('Your name')}),
        error_messages={'required': _('Please enter your full name')}, required=True)
    email = forms.EmailField(label=_('Your email'), widget=forms.EmailInput(
        attrs={'class': 'form-control',
               'title': _('Please enter your email address'), 'placeholder': _('Your email')}),
    ...
    message = forms.CharField(label=_('Your message'), widget=forms.Textarea(
        attrs={'class': 'form-control', 'placeholder': _('Your message'), 'cols': 40, 'rows': 10,
